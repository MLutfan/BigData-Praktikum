...
df.cache() # Menyimpan di memori agar proses selanjutnya lebih cepat
raw_count = df.count()
...
# 3. Filter nilai yang tidak masuk akal (harga dan jumlah harus lebih dari 0)
...
# Membuat kolom metrik baru: total_amount = price * quantity
...
# =========================
# SAVE DATA (STORAGE OPTIMIZATION)
# =========================
...
# Strategi Partition Pruning (dibagi per folder kategori)
df_transformed.write.mode("overwrite") \
